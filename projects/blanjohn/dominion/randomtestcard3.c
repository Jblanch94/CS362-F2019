...
{	
	...
	for(i = 0; i < 5000; i++)
	{
		...
		//have counts for treasure card, victory card and action card
		for(j = 0; j < 2; j++)
		{
        ...
        //test if treasure card count is 1 and if it adds 2 coins to player
        ...
        //test if treasure card count is 2 and if it adds 4 coins to player
        ...
        //test if victory card count is 1 and if it has player draw 2 cards
        ...
        //test if victory card count is 2 and if it has player draw 4 cards
        ...
        //tests if action card count is 1 and it gives player +2 actions
        ...
        //tests if action card count is 2 and it gives player +2 actions
